...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    const MINIMAL_RAW_EN_LOCALE = {
        ...
        allDayText: 'Tous',
        moreLinkText: 'plus',
        noEventsText: 'Aucun évenement à afficher',
    };
    const RAW_EN_LOCALE = Object.assign(Object.assign({}, MINIMAL_RAW_EN_LOCALE), { 
        ...
        }, viewHint: 'Vue par $0', navLinkHint: 'Aller dans $0', moreLinkHint(eventCnt) {
            return `Affichage ${eventCnt} plus d\'évenement${eventCnt === 1 ? '' : 's'}`;
        } });
